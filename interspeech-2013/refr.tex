...
\end{lyxcode}
\normalsize
where \inlinecode{<object>} is either a C++ primitive---one of
...
\begin{figure}
\begin{lyxcode}
// Specify the model output file.\\
model\_file = \textquotedbl my\_model\_file\textquotedbl;

\

// Construct a Model instance of run-time type\\
// PerceptronModel, specifying a score comparator\\
// object.\\
model =\\
~~PerceptronModel(\\
...
// Do run-time feature extraction using an\\
// \textquotedbl executive feature extractor\textquotedbl~which\\
// invokes the ExtractFeatures method from an\\
// internal vector of FeatureExtractor instances.\\
...
// Specify to use the above set of feature\\
// extractors for both training and dev datasets.\\
training\_efe = exec\_feature\_extractor;\\
dev\_efe = exec\_feature\_extractor;

\

// Specify the training and devtest files.\\
